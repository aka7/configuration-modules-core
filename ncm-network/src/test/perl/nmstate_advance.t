...
Readonly my $SRIOV_BOND_YML => <<EOF;
# File generated by NCM::Component::nmstate. Do not edit
---
interfaces:
- ipv4:
...
my $sriovyml = get_file_contents("/etc/nmstate/eth6.yml");
is($sriovyml, $SRIOV_YML, "Exact SR-IOV physical interface yml config");

my $sriovbondyml = get_file_contents("/etc/nmstate/bond2.yml");
is($sriovbondyml, $SRIOV_BOND_YML, "Exact SR-IOV bond yml config");
...
ok(command_history_ok([
  ...
  '/usr/bin/nmstatectl apply /etc/nmstate/eth6.yml',
  ...
  '/usr/bin/nmstatectl apply /etc/nmstate/bond2.yml',
